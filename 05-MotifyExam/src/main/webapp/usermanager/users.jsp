...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	       ...
	       $(function(){
	    	   ...
	    	   $("#delBtn").click(
	    		   function (){
	    			  $("form").attr("action","/05-MotifyExam/pxs/delectUser.do") ;
	    		   }	   
	    	   );
	    	   
	    	   $("#upBtn").click(
		    		   function (){
		    			  $("form").attr("action","/05-MotifyExam/pxs/findUser.do") ;
		    		   }	   
		    	   );
	...
	<body style="overflow: scroll; overflow-y: hidden">
		<div>
            ...
            <form action="/05-MotifyExam/pxs/listUsers.do" > 
			<div id="main">
				<!--main_top-->
				<div class="user_manager">
					<p>
						...
						<input type="button" value="添加" onclick="document.location='/05-MotifyExam/usermanager/userAdd.html'" style="width: 54px; height: 20px; margin-left: 15px;">
				...
				<div class="main_bottom">
						...
						<!-- 显示当前页的数据行内容    start -->
                         <c:forEach items="${requestScope.userList}" var="user">
							...
							<td style="color: #666666; font-size: 14px; text-align: center;">
								...
								<td style="color: #666666; font-size: 14px; text-align: center;">
								<c:set var="tid" value="学员" />
								<c:if test= "${user.flag<1 }"  >
								    <c:set var="tid" value="老师" />
								</c:if>
								${tid }
							</td>
						</tr>
					...
					<div>
							...
							<span style="color: red"> ${requestScope.pageNo} / ${requestScope.totalPage} </span>
