		...
		<div>
			...
			<div id="ks">
				...
				<div class="ks_bottom">
					...
					<div class="ti">
                     ...
                     <c:forEach items="${requestScope.questionList}" var="question">
						...
						<p style="padding-left: 36px">
							...
							<a href="/05-MotifyExam/pxs/findQuestion.do?questionId=${question.id }"><span
								style="color: #FF8005;">编辑</span>
							</a>&nbsp;&nbsp;
							<a href = "${pageContext.request.contextPath}/pxs/delectQuestion.do?questionId=${question.id }" ><span
                    ...
                    <form action="${pageContext.request.contextPath }/pxs/listQuestion.do">
